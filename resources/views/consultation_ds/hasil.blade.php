        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                $sql = "SELECT GROUP_CONCAT('(',code,'-',name,')') FROM ds_problems WHERE code IN ('" . implode("', '", $codes) . "')";
                                $result = $db->query($sql);
                ...
                <div class="text-center">
                    <a href="{{ route('consultation-dempster') }}" class="btn btn-primary">Diagnosa Lagi</a>
                </div>
            </div>
        </div>
    </section>
