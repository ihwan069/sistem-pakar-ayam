                            ...
                            <table class="table table-striped" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text">{{ $history->kepercayaan }} %</td>
                                        <td>{{ date_format($history->created_at,"d/m/Y") }}</td>
                                        <td class="text-center">
                                            <form action="{{route('history_ds.destroy', $history->id) }}" method="post" class="d-inline"  onsubmit="return confirm('Are you sure to delete the data?')">
                                                @method('delete')
                                                @csrf
