...
<div class="page-content">
    <section class="section col-9">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-vertical " method="post" action="{{ route('role_data.store')}}">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="id_problem">Hypothesis</label>
                                    <select id="id_problem" class="form-control @error('id_problem') is-invalid @enderror" name="id_problem" required>
                                        <option value="">Pilih Hypothesis</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="id_evidence" class="form-control @error('id_evidence') is-invalid @enderror" name="id_evidence" required>
                                        ...
                                        @foreach ($evidences as $evidence)
                                            <option value="{{ $evidence->id }}">{{ $evidence->code }} - {{ $evidence->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_evidence')
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="hidden" id="cf" class="form-control @error('cf') is-invalid @enderror" value="0.00" name="cf" required>
                                </div>
                            </div>
